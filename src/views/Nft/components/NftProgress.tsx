...
import { Card, CardBody, Heading, OpenNewIcon, Text, Link as UIKitLink, Progress } from '@mintswapcash/uikit'
        ...
        <InfoRow>
          ...
          <div>
            {!isInitialized ? (
              ...
              <Link href={`https://mintme.com/explorer/block/${endBlockNumber}`} target="_blank" rel="noreferrer noopener">
